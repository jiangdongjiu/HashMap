...
{
    /// <summary>
    /// Test the hashmap.Item constructor to make sure it sets the properties properly.
    /// </summary>
        @Test
    void ItemConstructorTest()
    {
        String name = "Awesome hashmap.Item";
        int value = 100;
        double weight = 5.0;
    ...
    void ToStringTest()
    {
        String expectedResult = "Awesome hashmap.Item is worth 100gp and weighs 5kg";

        Item item = new Item("Awesome hashmap.Item", 100, 5.0);
    ...
    void CompareToSameObjectTest()
    {
        ...
        Item item = new Item("hashmap.Item", 10, 5.0);
    ...
    {
        int expectedResult = 0;
        Item item1 = new Item("hashmap.Item", 10, 5.0);
        Item item2 = new Item("hashmap.Item", 10, 5.0);
    ...
    /// <summary>
    /// Test CompareTo with a hashmap.Item with a name that comes aphabetically after the instance.
    /// </summary>
        @Test
    ...
    /// <summary>
    /// Test that Equals returns false when a non hashmap.Item object is passed in.
    /// </summary>
        @Test
    ...
    /// <summary>
    /// Test that Equals returns true when a hashmap.Item with a matching name/gold/weight is compared.
    /// </summary>
        @Test
    ...
    /// <summary>
    /// Test that Equals returns false when a hashmap.Item with a mismatching name is compared.
    /// </summary>
        @Test
    ...
    /// <summary>
    /// Test that Equals returns false when a hashmap.Item with a mismatching gold value is compared.
    /// </summary>
        @Test
    void EqualsMisMatchedObject_gold_values_differ_Test()
    {
        Item item1 = new Item("hashmap.Item", 10, 5.0);
        Item item2 = new Item("hashmap.Item", 11, 5.0);
    ...
    /// <summary>
    /// Test that Equals returns false when a hashmap.Item with a mismatching weight is compared.
    /// </summary>
        @Test
    void EqualsMisMatchedObject_weight_values_differ_Test()
    {
        Item item1 = new Item("hashmap.Item", 10, 5.0);
        Item item2 = new Item("hashmap.Item", 10, 4.0);
